...
$bp      = $prof_base_path ?? $base_path ?? '/professeur';
$solde   = (float) ($solde ?? 0);
...
<div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1.25rem">
    <a href="<?= $e($baseUrl . $bp . '/portefeuille') ?>" style="display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:50%;background:var(--border);color:var(--text-muted);text-decoration:none;flex-shrink:0" aria-label="Retour">
...
<p style="margin:0 0 1rem;font-size:0.85rem;color:var(--text-muted);line-height:1.45">
    Indiquez le <strong>réseau</strong> sur lequel vous recevez vos paiements Mobile Money.
</p>

<div style="background:linear-gradient(135deg,#1d4ed8,#1e40af);border-radius:var(--radius);padding:1rem 1.25rem;margin-bottom:1.25rem;color:#fff">
...
<p style="margin:0;font-size:0.72rem;color:var(--text-muted);text-align:center;line-height:1.4">
    Traitement sous 24–48 h après validation par l’administration.
</p>
